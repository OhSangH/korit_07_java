...
public class FactoryMain {
    public static void main(String[] args) {
        ...
        /*
            이상의 코드를 생핼시켰을때 알 수 있는 점으로는
            어느 공장 객체에서 메서드를 호출 했든지 간에 상관없이
            createSerialNumber() 메서드를 호출한 결과가 하나로 이루어진다.
            그래서 다수의 공장 객체에서 각각 produceSmartPhone()로 객체를 생성하더라도
            시리얼 넘버는 분리 되는걸 확인 할 수 있다.
         */
    }
}
